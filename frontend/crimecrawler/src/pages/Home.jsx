        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Enter a candidate's name to search for criminal records. Please ensure you have proper authorization
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            {!loading && records.length > 0 && (
              <div>
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <h4 className="text-xl font-bold text-gray-900">Records Found for "{name}"</h4>
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <p className="mt-1 text-lg font-semibold text-gray-900">{record.name}</p>
                        </div>

                        <div>
                          <label className="text-sm font-medium text-gray-500 uppercase tracking-wide">Offense</label>
                          <p className="mt-1 text-lg text-gray-900">{record.offense}</p>
                        </div>
            ...
            {!loading && searchAttempted && records.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">No criminal records found for "{name}". This is a clean result.</p>
              </div>
            )}
          </div>
        )}
